...
const DelegationWithPP: React.FC<DelegationProps> = ({ context }) => {
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn btn-primary mt-4">Submit Delegation</button>
          </form>
        </div>
      </div>
    </div>
...
export default DelegationWithPP;
